//#region node_modules/.nitro/vite/services/ssr/assets/brand-C151bFRS.js
var BRAND = {
	name: "Elfurat Spices",
...
var CERTS = [
	{
		name: "APEDA",
		src: `${CDN}/APEDA%20Logo.png`
	},
	{
		name: "FSSAI",
		src: `${CDN}/FSSAI%20Logo.png`
	},
	{
		name: "FDA",
		src: `${CDN}/FDA-Emblem-logo.png`
	},
	{
		name: "ISO",
		src: `${CDN}/ISO%20Logo.png`
	},
	{
		name: "Spice Board of India",
		src: `${CDN}/Spice%20Board%20Logo.png`
	}
];
var HERO_IMAGES = {
...
//#endregion
export { LOGOS as a, HERO_IMAGES as i, CDN as n, waUrl as o, CERTS as r, BRAND as t };
