...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://elfuratspices.com/assets/16A.webp" },
      { property: "og:image:width", content: "1920" },
      { property: "og:image:height", content: "1080" },
      { property: "og:url", content: "https://elfuratspices.com/contact" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://elfuratspices.com/assets/16A.webp" },
    ],
  }),
  component: Contact,
});
